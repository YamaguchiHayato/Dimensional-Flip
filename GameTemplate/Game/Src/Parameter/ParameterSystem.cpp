...
namespace nsApp
{
    namespace nsSystem
    {
        ...
        bool ParameterSystem::LoadAllParameterTables()
        {
            ...
            /* StageMasterTSV。*/
            isSuccess_ &= StageMasterTable::LoadTSVFile(MakeParameterPath("StageMaster.tsv").c_str());

            /* StageSpawnTSV。*/
            isSuccess_ &= StageSpawnTable::LoadTSVFile(MakeParameterPath("StageSpawn.tsv").c_str());
